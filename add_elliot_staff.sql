-- Add Elliot as a genuine real staff member, PIN 0000 (same as
...
VALUES ('fab8b2d2-27b5-47ec-8c56-268bbf821dc3', 'Elliot', 'Director', true);
...
FROM staff_team
WHERE studio_id = 'fab8b2d2-27b5-47ec-8c56-268bbf821dc3' AND name = 'Elliot';
