...
registerCustomerBookingRoute(app, supabase, DEMO_STUDIO_ID, logger);
...
registerBackfillRoutes(app, supabase, DEMO_STUDIO_ID, logger, axios, sharp, upload, logGeminiUsage);
