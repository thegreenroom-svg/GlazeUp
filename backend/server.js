...
registerClaudeVisionRoutes(app, supabase, DEMO_STUDIO_ID, logger, axios, upload, fs, sharp);
registerGridBackfillRoutes(app, supabase, DEMO_STUDIO_ID, logger, axios, upload, fs, sharp, logGeminiUsage);
