-- ═══════════════════════════════════════════════════════════
-- Genuine DEMO data for the the kiln-LINK network — clearly fictional,
...
SELECT * FROM (VALUES
  ('d0000001-0000-0000-0000-000000000001'::uuid, '10% off your first visit', 'Welcome offer for the kiln-LINK network customers visiting for the first time', CURRENT_DATE, CURRENT_DATE + interval '60 days'),
...
UNION ALL
SELECT 'Opted into the kiln-LINK network', '4 (40%)'
UNION ALL
